...
puts "Creating flats"
flat1 = Flat.create(name: "Beachside Villa at Balian Surf Break", description: "Great flat by the seas", address: "16 Villa Gaudelet, Paris", rooms: 2, price: 300, user_id: user.id)
